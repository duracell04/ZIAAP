...
export function ConstitutionBuilder({ state, updatePrinciple }: Props) {
  ...
  return <>
    <div className="page-intro"><span>Stage 2 · protocol constitution</span><h1>Configure the AI-native decision environment.</h1><p>The legal actor is the human arbitrator. The jointly authored ZIAAP protocol defines the tested procedure and reasoning environment through which that arbitrator will work.</p></div>
    <div className="definition-banner"><Scale size={21} /><div><strong>ZIAAP-powered arbitrator</strong><p>A human arbitrator legally appointed by the parties who conducts proceedings through this jointly configured, tested, and version-locked protocol.</p></div></div>
