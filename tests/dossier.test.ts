...
async function completeSyntheticJourney() {
  ...
  complete.proposedDetermination = { id: "determination", appointmentHash: hash, issues: ["credit"], findings: ["CHF 1,500"], sourceIds: ["source-draft-sla"], counterarguments: ["causation disputed"], uncertainty: ["notice record missing"], escalationFlags: ["human_judgment"], reasoningSummary: "Mechanical credit only; residual issues reserved.", proposedDisposition: "Illustrate the credit and reserve residual issues.", materialStatus: "proposed_determination", independentLegalEffect: false, metadata: { executionMode: "illustrative", executionStatus: "illustrative_only", artifactId: "determination-illustrative-v1", label: "Illustrative protocol determination", provenance: "Curated offline synthetic fixture" } };
  complete.humanDecision = { preliminaryAssessment: "Independent fictional view", status: "modified", rationale: "The fictional human record modifies the provisional reasoning.", checklist: { sourcesReviewed: true, objectionsReviewed: true, calibrationChecked: true, independentJudgment: true }, simulatedSignature: "simulated decision record · no legal effect", materialStatus: "human_decision" };
