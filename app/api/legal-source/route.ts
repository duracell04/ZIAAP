...
export async function POST(request: Request) {
  ...
  if (process.env.ZIAAP_LIVE_RETRIEVAL_ENABLED !== "true") return failureResponse(executionFailure("live_execution_disabled", "Live legal-source retrieval is disabled in this concept environment.", false), 403);
  try {
