...
|---|---|---|
| Product | One category thesis, six gates, visible current/future boundary, funding roadmap | C0 operating-model language implemented; external acceptance pending |
...
## Current refactor review checklist
