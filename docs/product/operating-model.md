...
Parties align material operational expectations and configure the rules before
conflict. This is the Zero Instance: hidden differences are exposed while both
parties still want the commercial relationship to work.

### I1 · Cockpit

The exact configuration is frozen for the simulated matter and the dispute is
represented as a structured, contestable case state. Software performs
administrative and mechanical work. AI analysis remains advisory.

### I2 · Captain in Command

The human arbitrator reviews the record independently, records a preliminary
assessment before seeing the advisory proposal and retains responsibility for
the outcome. The procedural record remains inspectable without capturing
private human deliberation.

## Six gates of a matter

| Layer | Gate | Purpose | Current C0 boundary |
|---|---|---|---|
| I0 · Flight Plan | 1. Alignment | Resolve material differences in operational contract expectations | Synthetic party profiles and clause confirmations |
| I0 · Flight Plan | 2. Configuration | Assemble the Constitution, evidence policy, deterministic tools, scenario tests and permitted AI uses | Curated or live-unverified tests with no legal effect |
| I1 · Cockpit | 3. Appointment & Configuration Freeze | Identify the human arbitrator, freeze the configuration and record integrity evidence | Fictional appointment simulation and internal change-detection hash |
| I1 · Cockpit | 4. Case Production | Maintain the structured, versioned and contestable case state | Synthetic dispute and sealed settlement simulation |
...
> **The Constitution is the versioned control plane that converts arbitral
> governance into explicit system permissions, workflow boundaries,
> escalation rules and invalidation conditions.**
...
- party symmetry and challenge rights;
- mandatory escalation;
- human-only decisions; and
- invalidation after behavior-affecting configuration changes.

“Machine-enforceable” means enforced by software permissions and workflow
...
The reasoning memorandum is a source-linked advisory artifact derived from
this state. It is not the authoritative case model, a verdict, an award or a
substitute for independent human judgment.

## Authority decomposition

| Authority class | Permitted system role |
|---|---|
| Administrative | Organise, retrieve, classify and record |
| Mechanical | Apply explicit formulas to verified inputs |
| Advisory | Analyse, compare, draft and propose |
| Adjudicative | Prepare material for a properly appointed human tribunal; software does not exercise this authority |

The operating standard is:

> **Independent merits determination, assisted by structured preparation, with
> zero algorithmic presumption.**

The human arbitrator may adopt verified parts, modify them, reject them,
request more evidence, interpret the contract differently or determine another
remedy. The reasoning memorandum receives no deference because it is
machine-generated.
...
The intended source of leverage is:

```text
Shared engineering
+ reusable case structures
+ vertical knowledge
...
It is not a claim that one arbitrator can decide a specified multiple of cases
or that any particular cost, duration or quality result has been achieved.

## Procedural black box

The future procedural black box preserves the configuration identity,
procedural events, evidence provenance, party objections, system outputs and
human approvals needed to inspect how the matter was administered. It is
generated from recorded events rather than separately authored display copy.

It does not record private arbitrator deliberation, prove runtime attestation
or establish legal validity. The current C0 implementation is a synthetic
projection of this record.

## Evidence discipline

External evidence establishes context, not ZIAAP performance:

- [World Commerce & Contracting](https://www.worldcc.com/resource/contract-management-an-overlooked-driver-of-business-agility-and-financial-performance.html)
  reports average contract-value erosion and fragmented contract information.
  These figures do not establish value recoverable by ZIAAP.
- The [EU AI Act](https://eur-lex.europa.eu/eli/reg/2024/1689/oj?locale=en)
  supports careful human-oversight analysis for certain legally effective
  alternative-dispute-resolution uses. Classification depends on intended use
  and the applicable Article 6 analysis.
...
> **Radical operating-model ambition, conservative empirical claims.**

## Current approval and evidence status
